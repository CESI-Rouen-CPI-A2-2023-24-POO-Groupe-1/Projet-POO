...
namespace ProjetPOO {
	...
	public:
		...
		{
			InitializeComponent();
			this->textBoxIdSearch->Enter += gcnew System::EventHandler(this, &App_statistiques::textBoxIdSearch_Enter);
			this->textBoxIdSearch->Leave += gcnew System::EventHandler(this, &App_statistiques::textBoxIdSearch_Leave);
			this->textBoxNomSearch->Enter += gcnew System::EventHandler(this, &App_statistiques::textBoxNomSearch_Enter);
			this->textBoxNomSearch->Leave += gcnew System::EventHandler(this, &App_statistiques::textBoxNomSearch_Leave);
			this->textBoxPrenomSearch->Enter += gcnew System::EventHandler(this, &App_statistiques::textBoxPrenomSearch_Enter);
			this->textBoxPrenomSearch->Leave += gcnew System::EventHandler(this, &App_statistiques::textBoxPrenomSearch_Leave);
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBoxIdSearch->TextChanged += gcnew System::EventHandler(this, &App_statistiques::textBoxIdSearch_TextChanged);
			// 
			// textBoxNomSearch
			// 
			...
			this->textBoxNomSearch->TextChanged += gcnew System::EventHandler(this, &App_statistiques::textBoxNomSearch_TextChanged);
			// 
			// textBoxPrenomSearch
			// 
			...
			this->textBoxPrenomSearch->TextChanged += gcnew System::EventHandler(this, &App_statistiques::textBoxPrenomSearch_TextChanged);
			// 
			// dataGridView2
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &App_statistiques::pictureBox1_Click);
			// 
			// App_statistiques
			// 
			...
			this->Load += gcnew System::EventHandler(this, &App_statistiques::App_statistiques_Load);
...
#pragma endregion
	private: System::Void App_statistiques_Load(System::Object^ sender, System::EventArgs^ e) {
		SetInitialText();
	}
