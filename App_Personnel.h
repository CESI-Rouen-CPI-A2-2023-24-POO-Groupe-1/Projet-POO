...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Pôle de gestion du personnel";
			// 
			// Main_Titre_2
			// 
			...
			this->textBoxIdSearch->TextChanged += gcnew System::EventHandler(this, &App_Personnel::textBoxIdSearch_TextChanged);
			// 
			// textBoxNomSearch
			// 
			...
			this->textBoxNomSearch->TextChanged += gcnew System::EventHandler(this, &App_Personnel::textBoxNomSearch_TextChanged);
			// 
			// textBoxPrenomSearch
			// 
			...
			this->textBoxPrenomSearch->TextChanged += gcnew System::EventHandler(this, &App_Personnel::textBoxPrenomSearch_TextChanged);
			// 
			// dataGridView2
			// 
